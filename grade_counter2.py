...
parser = argparse.ArgumentParser(usage='grade_counter_parameter.py -i input_file -o output_file -r 5 -c 7 -t 300 -q yes -s 3 -e 8', add_help=True,formatter_class=argparse.RawDescriptionHelpFormatter)
